...
class MainWindow(QMainWindow):
    ...
    def add_test_rewards(self):
        ...
        role_model.add_reward(RoleReward(all_heroes[12], ROLES[2], 7, 1))
        ...
        role_model.add_reward(RoleReward(all_heroes[17], ROLES[2], 1, 4))
        role_model.add_reward(RoleReward(all_heroes[18], ROLES[3], 2, 1))
        role_model.add_reward(RoleReward(all_heroes[19], ROLES[4], 1, 1))
        role_model.add_reward(RoleReward(all_heroes[20], ROLES[0], 9, 1))
        role_model.add_reward(RoleReward(all_heroes[21], ROLES[1], 1, 1))
        role_model.add_reward(RoleReward(all_heroes[22], ROLES[2], 1, 1))
        role_model.add_reward(RoleReward(all_heroes[23], ROLES[3], 4, 4))
        role_model.add_reward(RoleReward(all_heroes[24], ROLES[4], 1, 1))
        role_model.add_reward(RoleReward(all_heroes[25], ROLES[0], 1, 1))
        role_model.add_reward(RoleReward(all_heroes[26], ROLES[1], 1, 1))
        role_model.add_reward(RoleReward(all_heroes[27], ROLES[2], 1, 4))
        role_model.add_reward(RoleReward(all_heroes[28], ROLES[3], 1, 1))
        role_model.add_reward(RoleReward(all_heroes[29], ROLES[4], 1, 1))
        role_model.add_reward(RoleReward(all_heroes[30], ROLES[0], 1, 1))
        role_model.add_reward(RoleReward(all_heroes[31], ROLES[1], 1, 4))
        role_model.add_reward(RoleReward(all_heroes[32], ROLES[2], 1, 1))
        role_model.add_reward(RoleReward(all_heroes[33], ROLES[3], 1, 1))
        role_model.add_reward(RoleReward(all_heroes[0], ROLES[1], 5, 10))
        role_model.add_reward(RoleReward(all_heroes[1], ROLES[2], 1, 6))
        role_model.add_reward(RoleReward(all_heroes[2], ROLES[3], 0, 1))
        role_model.add_reward(RoleReward(all_heroes[3], ROLES[4], 1, 1))
        role_model.add_reward(RoleReward(all_heroes[4], ROLES[0], 1, 6))
        role_model.add_reward(RoleReward(all_heroes[5], ROLES[1], 1, 1))
        role_model.add_reward(RoleReward(all_heroes[6], ROLES[2], 8, 1))
        role_model.add_reward(RoleReward(all_heroes[7], ROLES[3], 1, 7))
        role_model.add_reward(RoleReward(all_heroes[8], ROLES[4], 1, 1))
        role_model.add_reward(RoleReward(all_heroes[9], ROLES[0], 1, 1))
